...

    {
        const b_tiny = b.addExecutable(.{
            ...
            .root_module = b.createModule(.{
                ...
                .target = target,
                .optimize = optimize,
                .imports = &.{.{ .name = "zigora-tinyufo", .module = tinyufo_mod }},
            }),
        });
    ...
    }
    {
        const b_lru = b.addExecutable(.{
            ...
            .root_module = b.createModule(.{
                ...
                .target = target,
                .optimize = optimize,
                .imports = &.{.{ .name = "zigora-lru", .module = lru_mod }},
            }),
        });
    ...
    }
    {
        const b_ket = b.addExecutable(.{
            ...
            .root_module = b.createModule(.{
                ...
                .target = target,
                .optimize = optimize,
                .imports = &.{.{ .name = "zigora-ketama", .module = ketama_mod }},
            }),
        });
    ...
    }
    {
        const b_lim = b.addExecutable(.{
            ...
            .root_module = b.createModule(.{
                ...
                .target = target,
                .optimize = optimize,
                .imports = &.{.{ .name = "zigora-limits", .module = limits_mod }},
            }),
        });
